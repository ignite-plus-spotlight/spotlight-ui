...
import Option1Contents from './Option1Contents';
import Option2Contents from './Option2Contents';

const drawerWidth = 240;

const levelA =["Option3", "Option4"];
const levelB =  ["Option1", "Option2", "Option3"];
const levelC = ["Option1", "Option4", "Option5"]
...
class PersistentDrawerLeft extends React.Component {
    ...
    knowMyName = (event) => {
      // alert(event)
      if(event === "Option1"){
         this.setState({finalContents:<Option1Contents />}) 
      }
      if(event === "Option2"){
        this.setState({finalContents:<Option2Contents />})
    }
    }
