...
function MembersVp() {
  ...
  const [snackbarFail, setsnackbarFail] = React.useState(false);
    ...
    return (
      ...
      <Snackbar open={snackbarFail} autoHideDuration={10000} onClose={handleClose2}>
        ...
        >
          ...
          <StyledTableCell align="left"><Fab variant="extended" size="medium" style={{backgroundColor:CONST.COLOR.PRIMARY,color:"white"}} onClick={()=>handleClickOpen1(member)} align="right">
        Award
     </Fab></StyledTableCell> 
          ...
          <StyledTableCell align="left"><Fab variant="extended" size="medium" style={{backgroundColor:CONST.COLOR.PRIMARY,color:"white"}} onClick={()=>handleClickOpen2(emp)} align="right">
        Award
     </Fab></StyledTableCell>
            <AccordionDetails>
      ...
      <Table className={classes.table} aria-label="customized table">
        ...
        <StyledTableRow>
                ...
                <StyledTableCell align="left">{emp1.value.empEmail}</StyledTableCell>
                       <StyledTableCell align="left"><Fab variant="extended" size="medium" style={{backgroundColor:CONST.COLOR.PRIMARY,color:"white"}} onClick={()=>handleClickOpen(emp1)} align="right">
        Award
     </Fab></StyledTableCell>
            </StyledTableRow>
  ))}
        ...
        <InputLabel id="demo-simple-select-outlined-label" color="secondary">Award</InputLabel>
        <Select
    ...
    <DialogActions>
                        <Button onClick={handleClose} size="medium" style={{color:CONST.COLOR.PRIMARY}}>
                          Cancel
                        </Button>
                        <Button onClick={(e)=>submit(e)} size="medium" style={{color:CONST.COLOR.PRIMARY}}>
                        Send 
                        </Button>
                      </DialogActions>
                    </Dialog>
