    ...
    return (
      ...
      <Snackbar open={snackbarFail} autoHideDuration={10000} onClose={handleClose2}>
        ...
        >
          ...
          <StyledTableCell align="left"><Fab variant="extended" size="medium" style={{backgroundColor:CONST.COLOR.PRIMARY,color:"white"}} onClick={()=>handleClickOpen1(member.value.empId)} align="right">
        Award
     </Fab></StyledTableCell> 
        <AccordionDetails>
            <Typography>
      ...
      <Table className={classes.table} aria-label="customized table">
        ...
        <StyledTableRow >
                ...
                <StyledTableCell align="left"><Fab variant="extended" size="medium" style={{backgroundColor:CONST.COLOR.PRIMARY,color:"white"}} onClick={()=>handleClickOpen(emp.value.empId)} align="right">
             Award
            </Fab></StyledTableCell>
